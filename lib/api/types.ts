...
export type OrderCreateResponse = { orderNumber: string; status: 'PENDING_PAYMENT'; amounts: Amounts; payment: { provider: 'paystack'; reference: string; publicKey: string; authorizationUrl: string } };
