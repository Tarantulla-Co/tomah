...
export const faqs: Faq[] = [
  {id:'faq-1',question:'How are retail orders shipped?',answer:'Available services and the exact shipping amount are returned by the checkout service before payment.',category:'Shipping',position:1},
  {id:'faq-2',question:'How should maple products be stored?',answer:'Follow the storage directions on each package. Refrigerate maple butter after opening.',category:'Products',position:2},
  {id:'faq-3',question:'How do wholesale prices work?',answer:'Wholesale and bulk food prices are provided through individual quotes based on product, volume and destination.',category:'Wholesale',position:3},
];
export const testimonials: Testimonial[] = [
  {id:'test-1',quote:'Responsive sourcing and clear communication from enquiry through delivery.',name:'Wholesale customer',company:'Food distribution',rating:5},
];
const bySlug = (slug: string) => products.find(p=>p.slug===slug)!;
export const recipes: RecipeDetail[] = [
  {id:'recipe-1',slug:'maple-breakfast-bowl',title:'Maple breakfast bowl',excerpt:'A simple warm breakfast finished with pure maple syrup.',image:{url:'/images/maple-pancakes.jpg',alt:'Breakfast served with maple syrup',position:0},ingredients:['1 bowl cooked oats','Fresh fruit','1–2 tbsp Tomah maple syrup'],instructions:['Prepare the oats.','Top with fruit.','Finish with maple syrup and serve warm.'],relatedProducts:[bySlug('maple-syrup')]},
  {id:'recipe-2',slug:'maple-glaze',title:'Everyday maple glaze',excerpt:'A balanced sweet glaze for roasted vegetables or proteins.',image:{url:'/images/maple-syrup-lifestyle.jpg',alt:'Pure maple syrup ready for cooking',position:0},ingredients:['2 tbsp maple syrup','1 tbsp mustard','Pinch of salt'],instructions:['Whisk all ingredients together.','Brush onto food during the final minutes of cooking.'],relatedProducts:[bySlug('maple-syrup')]},
];
