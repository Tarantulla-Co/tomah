...
export type Testimonial = { id: string; quote: string; name: string; company: string };
export type RecipeSummary = { id: string; slug: string; title: string; excerpt: string; image: ImageAsset };
export type RecipeDetail = RecipeSummary & { ingredients: string[]; instructions: string[]; relatedProductIds: string[] };
